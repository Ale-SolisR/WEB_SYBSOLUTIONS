...
export default function AdminChatbot() {
  ...
  return (
    <div className="max-w-3xl space-y-6">
      <div>
        <h1 className="text-xl font-semibold" style={{ color: "var(--color-text)" }}>Chatbot</h1>
        <p className="text-sm mt-0.5" style={{ color: "var(--color-text-muted)" }}>
          Información de contexto que el asistente usa para responder a los visitantes
        </p>
      </div>
      ...
      {loading ? (
        ...
        <div className="space-y-4">
          ...
          >
            <p className="font-medium mb-1" style={{ color: "var(--color-text)" }}>¿Cómo funciona?</p>
            <p>El chatbot responde automáticamente sobre precios, demos, ERP y servicios. Aquí editas la información extra que usará como contexto: contacto actualizado, nuevos módulos, precios específicos, etc.</p>
          </div>
          ...
          <div className="card p-4">
            <p className="text-xs font-medium mb-2.5" style={{ color: "var(--color-text-muted)" }}>
              Temas respondidos automáticamente
            </p>
            <div className="flex flex-wrap gap-2">
              {["Saludos", "ERP", "Precios y planes", "Agendar demo", "Contacto", "Servicios TI", "Ubicación"].map((t) => (
                <span
                  key={t}
